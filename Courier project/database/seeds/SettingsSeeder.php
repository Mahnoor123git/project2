...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('general_settings')->insert([
            ...
            'header_title' => 'Courier Management',
            'header_subtitle' => 'Courier Management is a Branch based courier management system. Courier or Parcel Sender will send from a branch. Receiver will receive from destination branch set on sending !',
